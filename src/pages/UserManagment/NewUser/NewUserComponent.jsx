...
function NewUserComponent(props) {
  ...
  return (
    <Content className="swt-dashboard" isLoaded="true">
      ...
      >
        <DialogTitle
          sx={{ fontFamily: "Encode Sans", fontSize: "22px", fontWeight: "300" }}
        ...
        <DialogContent>
          <DialogContentText
            sx={{ fontFamily: "Encode Sans", fontSize: "16px", fontWeight: "300" }}
      ...
      >
        <DialogTitle
          sx={{ fontFamily: "Encode Sans", fontSize: "18px", fontWeight: "300" }}
          id="alert-dialog-title"
        >
