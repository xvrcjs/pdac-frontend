...
const DataGrid = ({
  ...
  const handleEdit = (row, rowIndex) => {
    if (row.type_of_claim.includes("hv_ive")){
      navigate(`reclamo-ive/${row.uuid}`);
    } else {
      navigate(`/mesa-de-entrada/reclamo/${row.uuid}`);
    }
  };
                      ...
                      >
                        ...
                        row && Object.keys(row).length > 0 && (
                          <>
                            {row.assigned === "S/A" ? (
                              <img
                                src="../../assets/claims/table/paper_plane.svg"
                                alt="asignar-reclamo"
                              ...
                              <img
                                src="../../assets/claims/table/forward_circle.svg"
                                alt="re-asignar-reclamo"
